...
export const assets = {
  menu_icon, plus_icon, message_icon, question_icon, history_icon, 
  setting_icon, user_icon, gemini_icon, compass_icon, bulb_icon, 
  code_icon, gallery_icon, mic_icon, send_icon
}
